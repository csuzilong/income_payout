...
c_path = '/home/biao.liu/payoutincome/test2'
...
def main():
    # 生成csv文件
    income_path = '%s/fin_relation_income_02.csv' % (c_path)
    payout_path = '%s/fin_relation_payout_02.csv' % (c_path)
    result_path = '%s/fin_relation_result_02.csv' % (c_path)
    ...
    # 处理后的结果导入hive
    df_to_table(data_result, result_path, "tmpdb.incr_d_fin_income_payout_rel_result_02")
