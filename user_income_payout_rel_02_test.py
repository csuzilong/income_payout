...
def main():
    ...
    table_to_csv(income_path, "tmpdb.inpy_income_rest_dtl_01")
    table_to_csv(payout_path, "tmpdb.inpy_user_payout_dtl_01")
    ...
    # 处理后的结果导入hive
    df_to_table(data_result, result_path, "tmpdb.incr_d_fin_income_payout_rel_result")
